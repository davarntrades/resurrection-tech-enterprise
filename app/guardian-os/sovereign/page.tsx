        ...
        <section className="sov-hero">
          ...
          <div className="sov-wrap sov-hero-layout">
            <div>
              ...
              <div className="sov-actions"><Link href="/book" className="sov-btn primary">Request a sovereign briefing</Link><a href="#value" className="sov-btn">Review the value comparison</a></div>
            </div>
