...
async function gather(org) {
  ...
  return {
    ...
    engagement_stage: eng.stage || "prospect",
    engagement_stage_label: eng.stage_label || engagement.stageLabel(eng.stage || "prospect"),
...
function derive(org, envs, badges, sig) {
  ...
  return {
    ...
    signals: {
      ...
      engagement_stage: sig.engagement_stage, engagement_stage_label: sig.engagement_stage_label,
