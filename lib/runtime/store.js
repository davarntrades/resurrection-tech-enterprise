...
let _sb = null, _sbTried = false, _cloudRefused = false;
function supabase() {
...
function resetBackend() { _sb = null; _sbTried = false; _cloudRefused = false; }
...
module.exports = {
  DATA_DIR, backend, durable, id, nowISO, sha256, cloudRefused, resetBackend,
