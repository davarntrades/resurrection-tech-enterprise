...
const integrationGateway = require("./sovereign/integration-gateway-runtime").wrapIntegrationGateway(baseIntegrationGateway, store);
...
const approvedEnterpriseAction = require("./enterprise-approved-action");
integrationGateway.executeApprovedEnterpriseAction = (input, dependencies = {}) => approvedEnterpriseAction.executeApprovedEnterpriseAction(input, integrationGateway, {
  ...dependencies,
  enterpriseExecute: dependencies.enterpriseExecute || (integrationGateway.enterpriseProviderExecute
    ? integrationGateway.enterpriseProviderExecute(input, dependencies)
    : undefined),
});
const communicationRuns = require("./communication-runs");
const communicationAdapters = require("./communication-adapters");
const enterpriseActionRuns = require("./enterprise-action-runs");
const enterpriseActionAdapters = require("./enterprise-action-adapters");
...
module.exports = { store, startup, admin, engine, manifests, gateway, integrationGateway, bedrockInvocationRuns, communicationRuns, communicationAdapters, enterpriseActionRuns, enterpriseActionAdapters, customerSupportWorkflow, sovereign, metrics, reports, log, ratelimit, adminauth, adminaudit, preflight, alerts, deliverables, hub, notify, recommendations, engagement, lifecycle, customeradmin, fullaudit, enterpriseassessment, overview, health };
