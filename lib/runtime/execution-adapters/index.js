...
const { createExecutionGate, capabilitiesFor } = require("./contract");
...
module.exports = { governAndExecute, registry, executionEnvironments, evidence, capabilities: require("./capabilities"), errors: require("./errors") };
