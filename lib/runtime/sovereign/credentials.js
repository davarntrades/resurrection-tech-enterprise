...
function callbackProvider(callback) {
  return {
    async resolve(reference, context) { return callback(reference, context); },
  };
}
...
function providerDefinitions() {
  return Object.freeze({
    ...
    aws_secrets_manager: { implemented: false, contract_tested: true, customer_validation_required: true },
    azure_key_vault: { implemented: false, contract_tested: true, customer_validation_required: true },
    google_secret_manager: { implemented: false, contract_tested: true, customer_validation_required: true },
    hashicorp_vault: { implemented: false, contract_tested: true, customer_validation_required: true },
    kubernetes_secrets: { implemented: false, contract_tested: true, customer_validation_required: true },
