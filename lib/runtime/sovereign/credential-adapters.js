...
const { governedFetch } = require("./outbound-policy");
...
function awsSecretsManagerProvider({ client, GetSecretValueCommand } = {}) {
...
function azureKeyVaultProvider({ client } = {}) {
  return { async resolve(reference = {}) {
...
function googleSecretManagerProvider({ client } = {}) {
  return { async resolve(reference = {}) {
