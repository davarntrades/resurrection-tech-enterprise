...
async function createRun(input = {}) {
  ...
  return safe(await store.insert("enterprise_action_runs", {
    ...
    governance_policy: null, governance_rule: null,
    governance_trajectory_hash: null, governance_attestation: null, approval_status: null,
...
function decisionPatch(result, run, timings = {}) {
  ...
  const patch = {
    ...
    // Replay information: the trajectory hash and engine attestation that make
    // this verdict reproducible against the pinned ruleset.
    governance_trajectory_hash: governance.trajectory_hash || run.governance_trajectory_hash || null,
    governance_attestation: governance.engine_attestation || run.governance_attestation || null,
