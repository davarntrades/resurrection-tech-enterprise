...
function connectorMarkdown(ca) {
  ...
  if ((ca.register || []).length) {
    ...
    if (ca.register_total > REGISTER_DISPLAY) L.push(`_Showing the ${REGISTER_DISPLAY} most recent of ${ca.register_total} records, newest first. Complete identifiers are preserved in the exported audit data._`, "");
...
function connectorHtml(ca, esc) {
  ...
  if ((ca.register || []).length) {
    ...
    if (ca.register_total > REGISTER_DISPLAY) H.push(`<p>Showing the ${REGISTER_DISPLAY} most recent of ${ca.register_total} records, newest first. Complete identifiers are preserved in the exported audit data.</p>`);
