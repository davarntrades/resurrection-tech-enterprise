...
function toHtml(r) {
  ...
  return `<!doctype html><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Runtime Governance — ${esc(r.period)} report</title>
<style>${FONT_FACE_CSS}body{font:15px/1.6 "TeX Gyre Pagella",Georgia,serif;color:#12151a;max-width:820px;margin:40px auto;padding:0 24px}
h1,h2,table,.risk,.muted{font-family:"TeX Gyre Heros",Arial,sans-serif}
...
@media screen and (max-width:600px){body{width:100%;margin:0;padding:24px 18px 40px;overflow-wrap:anywhere}h1{font-size:21px}table{table-layout:fixed}td,th{overflow-wrap:anywhere}}</style>
