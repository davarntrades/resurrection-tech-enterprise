...
async function followUps({ days = 7 } = {}) {
  ...
  return {
    ...
    email: {
      available: false,
      reason: "Email activity unavailable — Gmail integration not configured.",
      note: "Manual engagement notes contribute to the briefing until email integration exists.",
    },
  };
}
