...
function heuristics(snapshot) {
  ...
  for (const o of snapshot.observations || []) {
    ...
    } else if (o.kind === "customers.email_awaiting_reply") {
      recs.push({
        decision: "notify_operator", confidence: 0.75, org_id: o.org_id,
        reason: `Customer email awaiting reply: ${o.summary}. Raise an operator work item to respond.`,
        params: { org_id: o.org_id, message: o.summary },
      });
