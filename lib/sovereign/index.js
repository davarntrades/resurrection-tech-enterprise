 ...
 *   pdf        PDF 1.4 bytes from Node stdlib alone — no Chromium anywhere
 *   report     the shared section vocabulary, laid out on paper
 *   controls   control mapping + gap register (a self-assessment, never an
 *              accreditation)
 *   acceptance the site acceptance suite that runs on the target hardware
 *
...
module.exports = { profiles, bundle, packs, updates, immutable, verify, pdf, report, controls, acceptance, status };
