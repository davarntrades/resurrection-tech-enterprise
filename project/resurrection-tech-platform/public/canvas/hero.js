/* ============================================================
   ...
   ============================================================ */
(function () {
  // Re-entrancy: cancel any prior instance's loop before starting a new one
  // (supports SPA client-side navigation / React Strict-Mode remounts).
  if (typeof window !== 'undefined' && window.__rtHeroStop) {
    try { window.__rtHeroStop(); } catch (e) {}
  }
  ...
  // Expose a stop-hook so a re-injected instance can cancel this loop.
  if (typeof window !== 'undefined') {
    window.__rtHeroStop = function () {
